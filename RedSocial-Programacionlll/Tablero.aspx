    ...
    <% if (Usuario != null)
        ...
        <div class="ui two column doubling stackable grid container">
          <div class="column" style="width: 30%">
            ...
            <asp:TextBox runat="server" ID="TxtHidden2" Visible="false" ></asp:TextBox>
            ...
            <div class="ui middle aligned selection list" style="height: 300px; margin-top: 10px; overflow-y: scroll">
                ...
                <% while (NodoSeg != null) { %>
                    ...
                    <% if(typeof(Usuario).Equals(Registro.GetType())) {%>
                        ...
                        <% TxtHidden2.Text = item.NombreUsuario; %>

                        <%--<asp:LinkButton runat="server" data-usr="<%= TxtHidden2.Text %>" CssClass="itm-block" OnClick="VisitarPerfil">--%>
                            <div class="item" onclick="Site.ui.VisitarPerfil('<%= item.NombreUsuario %>')">
		                        <img class="ui avatar image" src="https://semantic-ui.com/images/avatar/small/helen.jpg">
		                        <div class="content">
		                          <div class="header"><%= item.NombreUsuario %></div>
		                        </div>
		                    </div>
                        <%--</asp:LinkButton>--%>
	                ...
	                <%} else {%>
                        ...
                        <% while (NodoComp != null) { %>
                            ...
                            <% TxtHidden2.Text = ncItem.NombreUsuario; %>
            
                            <%--<asp:LinkButton runat="server" data-usr="<%= TxtHidden2.Text %>" CssClass="itm-block" OnClick="VisitarPerfil">--%>
                                <div class="item" onclick="Site.ui.VisitarPerfil('<%: ncItem.NombreUsuario %>')">
		                            <img class="ui avatar image" src="https://semantic-ui.com/images/avatar/small/helen.jpg">
		                            <div class="content">
		                              <div class="header"><%: ncItem.NombreUsuario %></div>
		                            </div>
		                        </div>
                            <%--</asp:LinkButton>--%>
            ...
            <div class="ui middle aligned selection list" style="height: 300px; margin-top: 10px;  overflow-y: scroll">
                ...
                <% while (NodoSeg2 != null) { %>
                    ...
                    <% if(typeof(Usuario).Equals(Registro2.GetType())) {%>
                        ...
                        <% TxtHidden2.Text = item2.NombreUsuario; %>
                    
                       <%-- <asp:LinkButton runat="server" data-usr="<%= TxtHidden2.Text %>" CssClass="itm-block" OnClick="VisitarPerfil">--%>
                            <div class="item" onclick="Site.ui.VisitarPerfil('<%: item2.NombreUsuario %>')">
		                        <img class="ui avatar image" src="https://semantic-ui.com/images/avatar/small//helen.jpg">
		                        <div class="content">
		                          <div class="header"><%: item2.NombreUsuario %></div>
		                        </div>
		                    </div>
                        <%--</asp:LinkButton>--%>
	                ...
	                <%} else {%>
                        ...
                        <% while (NodoComp2 != null) { %>
                            ...
                            <% TxtHidden2.Text = nssItem.NombreUsuario; %>

                            <%--<asp:LinkButton runat="server" data-usr="<%= TxtHidden2.Text %>" CssClass="itm-block" OnClick="VisitarPerfil">--%>
                                <div class="item" onclick="Site.ui.VisitarPerfil('<%: nssItem.NombreUsuario %>')">
		                            <img class="ui avatar image" src="https://semantic-ui.com/images/avatar/small/helen.jpg">
		                            <div class="content">
		                              <%--<div class="header"><%= TxtHidden2.Text %></div>--%>
                                        <div class="header"><%: nssItem.NombreUsuario %></div>
		                            </div>
		                        </div>
                           <%-- </asp:LinkButton>--%>
            ...
            <div class="ui segment" style="background: #f1f1f1; height: auto; min-height: 500px;">
                ...
                <% while (NodoPub != null) { %>
                    ...
                    <div class="ui raised card" style="width: 100%;">
                      <div class="content">
                        <div class="header"><%: Pub.Nombre %></div>
                        <div class="meta">
                      ...
                      <div class="extra content">
                        ...
                        <div class="right floated author">
                          <img class="ui avatar image" src="https://semantic-ui.com/images/avatar2/large/kristy.png"> <%: Pub.Usuario %>
                        </div>
                      </div>
                    </div>
